...
export default function AdminUsersPage() {
  ...
  const handleImpersonate = async (user: User) => {
    ...
    if (!confirm(`Start impersonating ${user.name}? You will be viewing the app as this user.`)) {
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        alert(`Now impersonating ${user.name}. The page will reload.`);
        // Reload to update session context
